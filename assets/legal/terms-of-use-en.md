...
Thank you for choosing Cigarrynos, a mobile and web application developed by Noratek SRL ("we", "us", "our"), a company registered in Belgium with VAT number BE0470043093. By accessing or using the Cigarrynos application or web app ("Service"), you agree to comply with these Terms of Use ("Terms"). Please read them carefully.
...
- Manage your personal Humidor, Wishlist, Favorites, and Tasted list
- Track your collection value and tasting history
- Export your data as PDF
- Follow users, like and comment on reviews
- Access advanced search and filtering features

### 5.3 Free Access (No Subscription)

Without a subscription, you can:
- Browse the entire cigar database
- Use basic search and filters
- View detailed cigar pages and community reviews

### 5.4 Expert Users (Invite Only)

Expert users are granted special permissions to:
- Approve and edit new cigar entries
- Merge duplicate records
- Edit or remove descriptions and reviews to ensure accuracy and data quality

Expert access is granted at our discretion and may be revoked at any time.
...
The Service may contain links to third-party websites or services that are not owned or controlled by Noratek SRL. We have no control over, and assume no responsibility for, the content, privacy policies, or practices of any third-party websites or services.
